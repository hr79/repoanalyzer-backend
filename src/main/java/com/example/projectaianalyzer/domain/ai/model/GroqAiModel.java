...
public enum GroqAiModel {
    ...
    CRITICAL_MAIN(GroqAiModelVersionRegistry.LLAMA_4_SCOUT_17B_16E_VERSION),
    CRITICAL_SUB(GroqAiModelVersionRegistry.GPT_OSS_120B),
    SIGNIFICANT_MAIN(GroqAiModelVersionRegistry.MOONSHOTAI_KIMI_K2_INSTRUCT_0905),
    SIGNIFICANT_SUB(GroqAiModelVersionRegistry.GROQ_COMPOUND),
    ...
    MEDIUM_HIGH_MAIN(GroqAiModelVersionRegistry.GPT_OSS_20B),
    MEDIUM_HIGH_SUB(GroqAiModelVersionRegistry.ALLAM_2_7B),
